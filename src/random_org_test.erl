...
test_f_custom() ->
    ...
    {ok, Emin} = webdrv_session:find_element(test_f_custom, "xpath", "/html/body/div/form/p[2]/input[1]"),
    webdrv_session:clear_element(test_f_custom, Emin),
    webdrv_session:send_value(test_f_custom, Emin, "5"),
    {ok, Emax} = webdrv_session:find_element(test_f_custom, "xpath", "/html/body/div/form/p[2]/input[2]"),
